...
export function StakingForm() {
  ...
  return (
    <Card
      size="3"
      style={{ width: "100%", maxWidth: "480px", background: "var(--blue-2)" }}
    >
                ...
                <div className="relative w-full">
                  <FormControl asChild>
                    <input
                      ...
                      className="w-full bg-gray-100 text-black text-4xl font-bold outline-none focus:ring-2 focus:ring-blue-500 rounded-lg p-4 text-left"
                      placeholder="0.00"
